...
public final class MenageDevicesFragment extends androidx.fragment.app.Fragment implements android.view.View.OnClickListener {
    ...
    private final void navigateToDeviceSettings(int postion, boolean isConnected) {
    }
    
    private final void navigateToSearchFragment(int postion, boolean isConnected) {
    }
