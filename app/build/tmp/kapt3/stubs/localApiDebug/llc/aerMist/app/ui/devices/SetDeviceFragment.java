...
public final class SetDeviceFragment extends androidx.fragment.app.Fragment implements android.view.View.OnClickListener {
    ...
    private llc.aerMist.app.models.MyDevice deviceObjectOne;
    @org.jetbrains.annotations.Nullable()
    private llc.aerMist.app.models.MyDevice deviceObjectTwo;
    @org.jetbrains.annotations.Nullable()
    private llc.aerMist.app.models.MyDevice deviceObjectThree;
    @org.jetbrains.annotations.Nullable()
    private llc.aerMist.app.models.MyDevice deviceObjectFour;
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.Nullable()
    public final llc.aerMist.app.models.MyDevice getDeviceObjectOne() {
        return null;
    }
    
    public final void setDeviceObjectOne(@org.jetbrains.annotations.Nullable()
    llc.aerMist.app.models.MyDevice p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final llc.aerMist.app.models.MyDevice getDeviceObjectTwo() {
        return null;
    }
    
    public final void setDeviceObjectTwo(@org.jetbrains.annotations.Nullable()
    llc.aerMist.app.models.MyDevice p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final llc.aerMist.app.models.MyDevice getDeviceObjectThree() {
        return null;
    }
    
    public final void setDeviceObjectThree(@org.jetbrains.annotations.Nullable()
    llc.aerMist.app.models.MyDevice p0) {
    }
    
    @org.jetbrains.annotations.Nullable()
    public final llc.aerMist.app.models.MyDevice getDeviceObjectFour() {
        return null;
    }
    
    public final void setDeviceObjectFour(@org.jetbrains.annotations.Nullable()
    llc.aerMist.app.models.MyDevice p0) {
    }
